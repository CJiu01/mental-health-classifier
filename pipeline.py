...
ch5/ch6/ch7 are lazily imported so quick mode works without
llama_cpp / bertopic installed (e.g. local Mac environment).
"""
...
class MentalHealthPipeline:
    ...
    def __init__(self, mode: str = "quick", session_id: str = None,
        ...
        self._prompter  = None   # PromptClassifier
        self._memory    = None   # EmotionalMemorySystem
    ...
    def _get_trend(self) -> list:
        return self._memory.get_trend() if self._memory else []

    def _get_trend_direction(self) -> str:
        return self._memory.get_trend_direction() if self._memory else "stable"
